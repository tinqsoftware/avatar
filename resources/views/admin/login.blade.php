<!doctype html>
<html lang="es">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Acceso · Juanito IA</title><link rel="stylesheet" href="{{ asset('css/platform.css') }}"></head>
<body class="platform-body centered">
<form class="card login-card" method="POST" action="{{ route('admin.login.store') }}">
    @csrf
    <span class="eyebrow">ADMINISTRACIÓN</span><h1>Juanito IA</h1><p>Ingresa con una cuenta administradora.</p>
